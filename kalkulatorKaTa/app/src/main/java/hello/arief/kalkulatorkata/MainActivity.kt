package hello.arief.kalkulatorkata
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mButtonHitung.setOnClickListener {
            ...
            //Mengambil nilai dari Editext dan mengubahnya ke tipe data double
            ...
            //mengunakan when untuk pengecekan mOperator yang dipilih
            when (mOperator) {
